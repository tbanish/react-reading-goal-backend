...
Book.create(title: "Hamlet", author: "William Shakespeare", finished: true)
Book.create(title: "The Odyssey", author: "Homer", finished: true)
Book.create(title: "Madame Bovary", author: "Gustave Flaubert", finished: true)
